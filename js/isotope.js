...
// Populate Iso grid
    ...
    var $newitems = 
            $('<div class="col-sm-6 col-md-3 col-lg-3 ' + portfolioimg[i].imgClass + '"><div class="portfolio-item"><div class="hover-bg"><a href="#"><div class="hover-text"><h4>' + portfolioimg[i].noteone + '</h4><small>' + portfolioimg[i].notetwo + '</small><div class="clearfix"></div><i class="fa fa-external-link-square"></i></div><img src="' + portfolioimg[i].cover + '" class="img-responsive darken" alt="' + portfolioimg[i].noteone + '"></a></div></div>');
